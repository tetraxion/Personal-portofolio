...
//                     />
//                     <span className="font-medium">Dwi Lutfi</span>
...
//                     <Link href="mailto:lutfid955@gmail.com" className="cursor-target">
//                         <SiGmail size={24} className="ms-2 hover:text-slate-900 dark:hover:text-slate-100" />
//                     </Link>
//                     <Link href="https://www.linkedin.com/in/dwi-lutfi-988026277/" className="cursor-target">
//                         <FaLinkedin size={24} className="ms-2 hover:text-slate-900 dark:hover:text-slate-100" />
//                     </Link>
//                     <Link href="https://instagram.com/lutfid955" className="cursor-target">
//                         <FaInstagram size={24} className="ms-2 hover:text-slate-900 dark:hover:text-slate-100" />
//                     </Link>
//                     <Link href="https://github.com/tetraxion" className="cursor-target">
